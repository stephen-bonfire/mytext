...
MyText allows you to export a markdown document as PDF and HTML file or to print the document.
...
MyText allows you to select a page theme before exporting. You can learn more about page themes [here](EXPORT_THEMES.md).
